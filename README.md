# Nodepay Automate with Proxies | Bypass!
...
1. Nodepay Account | Register: [https://app.nodepay.ai/register](https://app.nodepay.ai/register?ref=tRnP7FuySV2o2or)
2. Proxies Static Residental | [FREE 10 PREMIUM PROXIES](https://www.webshare.io/?referral_code=ppz6tdhtg6a3)
3. VPS (OPTIONAL) and Python3
# Setup Tutorial
- Open [Nodepay](https://app.nodepay.ai/register?ref=tRnP7FuySV2o2or) and login to dashboard
